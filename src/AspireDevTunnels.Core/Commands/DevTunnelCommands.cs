...
internal class DevTunnelCommands
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return devTunnelCommandResult.IsSuccess
            ...
            : throw new($"Error: {devTunnelCommandResult.Error}");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string errorMessage = devTunnelCommandResult switch
        {
            ...
            not null when string.IsNullOrWhiteSpace(devTunnelCommandResult.Output) =>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new(output, error, process.ExitCode);
    }
